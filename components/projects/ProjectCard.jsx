...
function PremiumCardShell({ children }) {
  return (
    <article className="relative flex h-full min-h-[420px] flex-col overflow-hidden rounded-2xl bg-white ring-1 ring-primary/8 shadow-[0_2px_16px_rgba(0,0,0,0.07)] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[0_20px_52px_rgba(0,0,0,0.14)] hover:ring-accent/30">
      <div className="absolute inset-x-0 top-0 z-20 h-[3px] origin-left scale-x-0 bg-linear-to-r from-accent to-accent-hover transition-transform duration-500 group-hover:scale-x-100" />
      {children}
    </article>
  );
}
