...
export function CTAComponents() {
  return (
    <>
      ...
      <section className="border-t border-border bg-linear-to-b from-surface to-white py-16 sm:py-20">
      ...
      <section id="cta" className="scroll-mt-20 px-4 sm:px-6 pb-16">
        <div className="relative max-w-7xl mx-auto">
          {/* Main Gradient Card */}
          <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-surface via-surface-2 to-surface p-8 md:p-12 lg:p-16 shadow-[0_2px_16px_rgba(0,0,0,0.07)] border border-border">
            ...
            <div className="relative text-center max-w-3xl mx-auto">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  asChild
                  size="lg"
                  className="rounded-lg bg-linear-to-r from-accent to-accent-hover text-white font-semibold text-base py-6 px-10 shadow-[0_2px_16px_rgba(0,0,0,0.07)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
                >
          ...
          <div className="mt-6 rounded-2xl border border-border bg-white p-8 md:p-10 shadow-[0_2px_16px_rgba(0,0,0,0.07)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
              ...
              <Button
                asChild
                className="rounded-lg bg-linear-to-r from-accent to-accent-hover text-white font-semibold text-base py-6 px-8 whitespace-nowrap shadow-[0_2px_16px_rgba(0,0,0,0.07)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.12)] hover:-translate-y-0.5 transition-all duration-300 cursor-pointer"
              >
                <Link href="/contact-us" className="flex items-center gap-2">
                  Get Your Proposal
                  <ArrowRight className="h-5 w-5" />
